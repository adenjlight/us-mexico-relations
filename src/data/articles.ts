...
const ECONOMIA_SINALOA = 'https://www.economia.gob.mx/datamexico/en/profile/geo/sinaloa-si';
const FAS_USDA_MEXICO = 'https://www.fas.usda.gov/regions/mexico';
const TRADE_GOV_AGRIBUSINESS = 'https://www.trade.gov/country-commercial-guides/mexico-agribusiness';
...
const articlesByRegion: Record<string, Article[]> = {
  ...
  northwest: [
    ...
    {
      id: 'article-3',
      title: 'Why Agriculture and Trade Drive the Economy of Northwestern Mexico',
      author: 'Dimitri Donas',
      excerpt: 'Northwestern Mexico\'s agricultural economy, anchored by Sinaloa and Sonora, has been built on geographic advantages, large-scale irrigation, and deep trade ties with the United States — making the region a critical driver of national food security and export revenue.',
      sections: [
        {
          paragraphs: [
            `The economic structure of northwestern Mexico is predominantly shaped by its most historically significant economic sectors: agriculture. States such as Sinaloa and Sonora play a central role in national food production and crop exportation, forming a regional economy that is deeply tied to farming and international trade. This concentration reflects a combination of geographic advantages, long-term investment, and cooperation with global markets that has positioned the northwest as one of Mexico's most productive agricultural regions.`,
            `Agriculture in Mexico's northwest operates at a scale and level of productivity that distinguishes it from many other parts of the country. Sinaloa is widely recognized as one of Mexico's leading agricultural producers, particularly in regards to high-value crops such as tomatoes, peppers, and corn. According to ${a('Mexico\'s economic data platform', ECONOMIA_SINALOA)}, the state generates billions of dollars in agricultural output annually and serves as a major exporter of fresh produce, much of which is shipped to international markets, especially the United States. This figure highlights the northwest region's role not only in supporting domestic food supply, but also in sustaining strong international trade relationships.`,
            `This pattern is evident in Sonora, where agriculture is integrated into a broader economic system. Sonora is a major producer of wheat, grapes, and livestock, playing a significant role in Mexico's export economy. The state's agricultural sector relies heavily on large-scale irrigation systems and modern farming techniques, allowing it to maintain high levels of productivity despite its arid climate. ${a('Mexican government and industry reports', FAS_USDA_MEXICO)} emphasize that Sonora's agricultural success is closely tied to decades of investment in irrigation infrastructure, including dams and canal systems that enable consistent crop production.`,
          ],
          imageAfterParagraph: { 2: '/images/northwest-agriculture-irrigation.png' },
        },
        {
          paragraphs: [
            `Geography is a critical factor in explaining the success of agriculture in northwestern Mexico. The region's coastal plains and river valleys provide fertile land suitable for large-scale farming, while its dry climate creates conditions where irrigation can be effectively controlled, allowing producers to manage water usage and crop cycles with high degrees of precision. Over the course of the 20th century, this combination of natural and engineered advantages has allowed the northwest to transition from subsistence farming to commercialized agriculture.`,
            `${a('Economic data', TRADE_GOV_AGRIBUSINESS)} reinforces the importance of agriculture within both the regional and national context. Mexico's agribusiness sector represents a major component of the country's economy, contributing significantly to exports and employment. The United States Department of Commerce reports that Mexico exports tens of billions of dollars in agricultural goods annually, with fruits and vegetables making up a large share of this trade. Northwestern states such as Sinaloa and Sonora are central to this economy, supplying a substantial portion of these exports due to their scale of production, as well as their geographical proximity to the U.S. and its markets. In fact, trade integration is one of the most important forces shaping agricultural development in the northwest. Mexico's geographic proximity to the United States allows for efficient transportation of perishable fresh produce, giving producers in the northwest a competitive advantage within the international trade stage. Fresh produce grown in Sinaloa and Sonora can reach U.S. consumers quickly, reducing costs. This advantage enables a steady demand for agricultural exports and reinforces the region's role as a key produce supplier within North American trade dynamics. Furthermore, trade agreements and border infrastructure further strengthen these connections.`,
          ],
        },
        {
          paragraphs: [
            `The structure of agricultural production in northwestern Mexico also reflects the country's broader shift toward large-scale agriculture and trade. Farms in this region are often equipped with advanced technologies, including irrigation systems, engineered crops, and modern harvesting machinery. These factors increase efficiency and output, allowing producers to meet the standards for quality and volume desired by international markets. At the same time, the concentration of economic activity in agriculture creates certain structural challenges. One of the most significant challenges is the region's need for and dependence on water resources. While irrigation systems have enabled agricultural expansion, they also require consistent maintenance. Furthermore, water scarcity and climate change pose risks to long-term agricultural productivity, particularly in high-performing or growing areas where the demand for water continues to increase. ${a('Reports', FAS_USDA_MEXICO)} from agricultural and environmental agencies emphasize that sustainable water management will be critical for maintaining the region's economic stability in the future.`,
            `Despite these challenges, agriculture remains a central driver of economic activity in northwestern Mexico. The region's ability to produce large quantities of valuable crops positions it as a key contributor to national food security, trade, and the greater economy. Its steady growth and integration into global markets has ensured consistent demand, while its infrastructure supports continued expansion. The broader significance of the northwest's invaluable agricultural economy lies in what it reveals about Mexican regional development, demonstrating how long term investment can compound to create a unique and productive economy. The success of states such as Sinaloa and Sonora reflects Mexico's long-term planning and adaptation to geographic and environmental conditions. This extensive development has been paired with the strategic use of trade relationships, ultimately promoting the growth of Mexico's domestic food production, trade relations, and economic activity.`,
          ],
          imageAfterParagraph: { 0: '/images/northwest-agriculture-harvest.png' },
        },
      ],
    },
  ],
