...
export const regions: Region[] = [
  {
    ...
    image: '/images/northwest-baja.jpg',
  ...
  },
  {
    ...
    population: '12.5M',
    image: '/images/northeast-monterrey.jpg',
  ...
  },
  {
    ...
    image: '/images/west-guadalajara.jpg',
  ...
  },
  {
    ...
    population: '17.4M',
    image: '/images/north-central-copper-canyon.jpg',
  ...
  },
  {
    ...
    image: '/images/central-mexico-city.jpg',
  ...
  },
  {
    ...
    population: '13.2M',
    description: 'Mexico\'s Southwest is a culturally rich and geographically diverse region known for its indigenous heritage and traditions, landscapes, and beaches. States like Oaxaca, Guerrero, and Chiapas feature mountains, jungles, and Pacific coastline. The region was also once home to ancient civilizations such as the Zapotec and Mixtec, whose influence remains visible in language, crafts, and cuisine. Cities like Oaxaca offer colonial architecture and lively markets, while rural communities preserve traditional ways of life. Others, such as Acapulco, are prime tourist destinations, both internationally and domestically. Agriculture, tourism, and local markets support the local economies of the Southwest. Despite economic challenges, the Southwest remains one of Mexico\'s most culturally-rich and historically significant regions today.',
    image: '/images/southwest-monte-alban.jpg',
  ...
  },
  {
    ...
    population: '5.1M',
    description: 'The Yucatán Peninsula, located in southeastern Mexico, is a region defined by its geographic isolation, cultural distinctiveness, and growing economic importance. Bordered by the Gulf of Mexico and the Caribbean Sea, it includes the states of Yucatán, Quintana Roo, and Campeche. Unlike other regions of Mexico, the peninsula is relatively disconnected from central transit corridors, shaping both its development and its role in national systems. Economically, the region has experienced significant growth, particularly through tourism concentrated in cities such as Cancún and Playa del Carmen, while Mérida has gained recognition for its safety and quality of life. At the same time, the Yucatán maintains a strong indigenous presence, with deep roots in Maya history that continue to influence its social and cultural landscape.',
    image: '/images/southeast-chichen-itza.jpg',
