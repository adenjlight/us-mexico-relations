...
const INDIGENOUS_MEXICO = 'https://www.indigenousmexico.org/articles/indigenous-yucatan-the-center-of-the-mayan-world';

export const southeastMigration = {
  id: 'article-3',
  title: 'Why Doesn\'t Migration Flow to the Yucatán Peninsula?',
  author: 'Daniel Davis',
  abstract: 'The Yucatán Peninsula is one of the safest and fastest-growing regions in Mexico, yet it remains largely outside major migration routes from Central and South America. This piece examines why migrants do not move through or settle in the region despite its apparent advantages. Migration patterns are shaped less by safety and economic opportunity and more by geography, infrastructure, and social networks. Together, these factors put the peninsula tangential to the dominant migratory networks and systems.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        `Migration through Mexico is often understood in terms of push and pull factors. Violence, poverty, and political instability push migrants out of their home countries, while safety and economic opportunity pull them toward new destinations. Under this framework, the Yucatán Peninsula appears to be a strong potential destination. Cities like Mérida are known for their safety, and tourism-driven growth in Cancún and Playa del Carmen has created expanding local economies.`,
        `Despite these conditions, the Yucatán is not a major destination or transit point for migrants from Central and South America. Instead, migration flows continue along established routes through other parts of Mexico. So if safety and opportunity are the root causes of migration, why is the Yucatán largely bypassed?`,
        `Yucatán demonstrates that migration patterns are not determined primarily by the attractiveness of destinations, but by the structure of migration systems. Geography, infrastructure, and migrant networks shape where people move, often being more important factors than safety. As a result, the Yucatán remains peripheral to migration flows even as it becomes more economically successful.`,
      ],
    },
    {
      heading: 'Geography and Route Formation',
      paragraphs: [
        `The geographic position of the Yucatán Peninsula plays an important role in explaining its lack of migrants. Those entering Mexico from Guatemala typically cross into Chiapas and follow routes that move northward toward the United States. These routes pass through states such as Veracruz or connect to central Mexico, forming corridors that have been used consistently over time.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `This distinction reinforces the argument that migration is not a uniform process. Different push and pull factors demand different responses to altered structural conditions.`,
      ],
    },
    {
      heading: 'Cultural Context',
      paragraphs: [
        `The cultural background of the Yucatán also shapes its migration patterns. The region has a strong indigenous presence, particularly among the Maya peoples. Their history and cultural influence remain significant. As written by ${a('Indigenous Mexico', INDIGENOUS_MEXICO)}, the peninsula has long been a center of Mayan civilization, resulting in enduring traditions and community structures.`,
        `This cultural continuity contributes to the region's distinct identity, but it may also create barriers for integration. Migrants from outside the region may lack the linguistic and social connections necessary to fully integrate into local communities easily. Additionally, the absence of established migrant populations limits the availability of support networks.`,
      ],
    },
    {
      heading: 'Conclusion',
